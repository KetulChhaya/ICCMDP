<div id="sideMenu" class="sideMenu">
    <div id="sideBar" class="sideBar top footer"></div>
    <div id="icon-grp-div" class="icon-grp-div top footer">
        <div class="icon-div">
            <a href="./objectives.php">
                ...
                <span class="iconName top">Objectives</span>
            </a>
        </div>
        <div class="icon-div">
            <a href="./call-for-paper.php"><i class="fas fa-bullhorn"></i><span class="iconName top">Call For Papers</span></a>
        </div>
        <div class="icon-div">
            <a href="./coming-soon.php#accomodation"><i class="far fa-building"></i><span class="iconName top">Accomodation</span></a>
        </div>
        <div class="icon-div">
            <a href="./index.php#imp-dates"><i class="far fa-calendar-check"></i><span class="iconName top">Calendar</span></a>
        </div>
        <div class="icon-div">
            <a href="./coming-soon.php#instructions"><i class="far fa-file-alt"></i><span class="iconName top">Instructions</span></a>
        </div>
        <div class="icon-div">
            <a href="./coming-soon.php#download"><i class="fas fa-download"></i><span class="iconName top">Downloads</span></a>
        </div>
    </div>
</div>